...
class Video extends Widget_Base {
    ...
    public function get_controls(): array {
        return [
            ...
            $this->number( 'border_radius', 'Border Radius', 8, 0, 50 ),
        ];
    }
    ...
    public function render( array $s ): void {
        ...
        echo "<div class=\"scb-video-wrap overflow-hidden\" style=\"position:relative;padding-bottom:{$ratio}%;height:0;border-radius:{$r}px;\">";
        if ( $embed_url ) {
